// From: https://github.com/KroneCorylus/.dotfiles/blob/main/ghostty/.config/ghostty/shaders/cursor_blaze_no_trail.glsl
...
// const vec4 TRAIL_COLOR = vec4(0.5098, 0.1059, 1.0, 0.721);
// const vec4 TRAIL_COLOR_ACCENT = vec4(1.0, 0.1412, 0.7725, 0.546);
const vec4 TRAIL_COLOR = vec4(0.482, 0.886, 1.0, 1.0);
const vec4 TRAIL_COLOR_ACCENT = vec4(0.0, 0.424, 1.0, 1.0);
const vec4 CURRENT_CURSOR_COLOR = vec4(0.482, 0.886, 1.0, 1.0);
const vec4 PREVIOUS_CURSOR_COLOR = vec4(0.0, 0.424, 1.0, 1.0);
