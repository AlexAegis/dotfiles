// From: https://github.com/KroneCorylus/.dotfiles/blob/main/ghostty/.config/ghostty/shaders/
...
// onst vec4 TRAIL_COLOR = vec4(1., 1., 0., 1.0);
const vec4 TRAIL_COLOR = vec4(1.0, 1.0, 1.0, 0.591);
