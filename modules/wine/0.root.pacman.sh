...
# list grabbed from https://github.com/lutris/docs/blob/master/WineDependencies.md
pacman -S --needed wine winetricks giflib lib32-giflib libpng lib32-libpng \
	...
	lib32-libxinerama ncurses lib32-ncurses ocl-icd lib32-ocl-icd libxslt \
